...
function selectParentName(){
	$('#parentName').combotree({    
		url : '${ctx}/manage/sys/company/findCompanyTreeOfSelect',
	    required: true,
...
//保存
function save(){
	var url = "${ctx}/manage/sys/company/save";
	$.ajax({
		type : "POST",
		dataType : "json",
		url : url,
		...
		<form id="company_form">
			<table>
				<tr>
					...
					<td><input id="companyName" name="companyName" class="easyui-textbox" data-options="required: true" style="width:200px;"> </td>
				</tr>
				<tr>
