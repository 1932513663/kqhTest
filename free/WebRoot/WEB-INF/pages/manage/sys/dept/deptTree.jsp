	...
	function initDeptTree(companyId,selectDeptId) {
		$('#deptTree').tree({
			...
			onSelect : function(node) {
				var deptId=node.id;
				window.parent.switchTo("/manage/sys/department/main?deptId="+deptId+"&companyId="+companyId);
			},
			onLoadSuccess:function(node,data){
				...
				if(nodeFirst==undefined){
					window.parent.switchTo("/manage/sys/department/main?companyId="+companyId);
				}else{
					if(node==null){
